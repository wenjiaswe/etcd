...
func newConfig() *config {
	...
	fs.BoolVar(&cfg.ec.PeerTLSInfo.SkipClientSANVerify, "experimental-peer-skip-client-san-verification", true, "Skip verification of SAN field in client certificate for peer connections.")
	...
	fs.BoolVar(&cfg.ec.ExperimentalEnableClusterDowngrade, "experimental-enable-cluster-downgrade", false, "Whether to enable cluster downgrade support.")
